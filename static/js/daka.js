$(function () {
    ...
    function addMapOverlay() {
        var markers = [
            { content: "有同学反应说我们常去的篮球馆和网球馆有些旧了。今天它来了！十一学校总结了大家公认需要翻新的地方，并付出以行动，给老篮球馆和网球馆充能。同学们现在可以放心地去挥洒青春了！在熟悉的老地方发现新的惊喜，快去探索吧！", title: "篮球馆和网球馆翻新", imageOffset: { width: -46, height: -21 }, position: { lat: 39.907225, lng: 116.260902 } },
            ...
            { content: "世界上有5651种语言，每一个都有它们自己的魅力，吸引着我们去探索。十一学校现在开设了小语种学习中心，给每一个有学习小语种欲望的十一学子一个难得的学习机会！就在图书馆五层小语种学习中心，快去探索吧！", title: "图书馆五层小语种学习中心", imageOffset: { width: -46, height: -21 }, position: { lat: 39.90681, lng: 116.262555 } },
            { content: "“绿色”，“健康”和“低脂”慢慢成为了现代人的饮食新标准，不少十一学子也在享受这一标准带来的健康生活。现在十一学校给这些同学或想感受轻食的同学提供一个补给站，提供特制轻食餐。就在远翥楼和体育馆中间，快去探索吧！", title: "轻食餐厅", imageOffset: { width: -46, height: -21 }, position: { lat: 39.906879, lng: 116.260354 } },
    ...
    function addMapControl() {
        ...
        copyright.addCopyright({ id: 1, content: "<a href='https://bndse.org/' target='_blank' style='font-size:15px;text-decoration:none;'>寰桐阁</a>", bounds: bound });
    }
